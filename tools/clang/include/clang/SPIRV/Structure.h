...
private:
  ...
  spv::ExecutionModel shaderKind; ///< Shader Type (Vertex, Fragment, etc.)
...
void SPIRVModule::setShaderKind(spv::ExecutionModel em) {
  shaderKind = em;
}
void SPIRVModule::addEntryPoint(EntryPoint ep) {
