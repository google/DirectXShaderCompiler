...
/// constant. type. It also includes a set of decorations that are applied to
/// that constant.
///
...
public:
  ...
  static const Constant *getFalse(SPIRVContext &ctx, uint32_t type_id,
                                  DecorationSet dec = {});
  static const Constant *getNumeric(SPIRVContext &ctx, uint32_t type_id,
  ...
  static const Constant *getSpecFalse(SPIRVContext &ctx, uint32_t type_id,
                                      DecorationSet dec = {});
  static const Constant *getSpecNumeric(SPIRVContext &ctx, uint32_t type_id,
                                        llvm::ArrayRef<uint32_t> value,
                                        DecorationSet dec = {});
  static const Constant *getSpecComposite(SPIRVContext &ctx, uint32_t type_id,
                                          llvm::ArrayRef<uint32_t> constituents,
                                          DecorationSet dec = {});
  // TODO: Implement OpSpecConstantOp if proven it adds any value
...
private:
  ...
  std::set<const Decoration *>
      decorations; ///< decorations applied to the constant
};
