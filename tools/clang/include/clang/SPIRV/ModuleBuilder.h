...
public:
  ...
  // === Constant ===
  uint32_t getConstantFloat32(uint32_t typeId, float value);
  uint32_t getConstantInt32(uint32_t typeId, int32_t value);
  uint32_t getConstantUint32(uint32_t typeId, uint32_t value);
