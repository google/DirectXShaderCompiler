...
// CHECK: [[file3:%\d+]] = OpString "../../tools/clang/test/CodeGenSPIRV/spirv.debug.opline.include-file-3.hlsl"
// CHECK: [[file3_code:%\d+]] = OpString "groupshared int b;
// CHECK: [[file2:%\d+]] = OpString "../../tools/clang/test/CodeGenSPIRV/spirv.debug.opline.include-file-2.hlsl"
// CHECK: [[file2_code:%\d+]] = OpString "static int a;
// CHECK: [[file1:%\d+]] = OpString "../../tools/clang/test/CodeGenSPIRV/spirv.debug.opline.include-file-1.hlsl"
